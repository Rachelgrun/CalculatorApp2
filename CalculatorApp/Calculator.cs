...
namespace CalculatorApp
{
    public class Calculator
    {
        ...
        {
            //if currentval is blank (null or 0) then set currentval = newval
            ...
            //else concat newval onto currentval as a string then tryparse it into currentval
            return currentval;
        }
        ...
        public string EquationDescription
        {
            get
            {
              ...
              string s =  Factor1.ToString() + OperatorDisplay.ToString() + Factor2.ToString();
                return s;
            }
